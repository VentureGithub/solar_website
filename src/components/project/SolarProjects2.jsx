...
const projects = [
  {
    ...
    location: "Gwalior, Madhay Pradesh",
  },
  {
    id: 2,
    image: "ss.jpg",
...
const SolarProjects2 = () => {
  return (
    <div className="bg-blue-50 text-orange-600 py-6 px-6 min-h-screen">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <div className="relative mt-10">
            <h3 className="text-2xl font-semibold text-orange-500 inline-block">
            Gwalior, Madhay Pradesh
            </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10 justify-center">
          {projects.map((project) => (
            ...
            >
              <div className="overflow-hidden rounded-2xl mb-6 s relative h-64">
